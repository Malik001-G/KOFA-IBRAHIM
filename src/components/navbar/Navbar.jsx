    ...
    <>
      ...
      >
          <NavLink to="/" className="flex flex-col items-start">
            ...
            />
            <motion.p
              className="text-xs font-normal ml-1 text-black"
      ...
      <AnimatePresence>
        {isModalOpen && (
          ...
          >
            ...
            >
              <motion.button
                className="absolute top-2 right-1 w-8 h-8 flex items-center justify-center rounded-full bg-black text-white transition-colors"
                onClick={closeModal}
